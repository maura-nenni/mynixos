...
#
# Instead of the appname filter, it's recommended to use the desktop_entry filter. GLib based applications export their desktop-entry name. In comparison to the appname,
...
#
			redirect = {
				summary = "*";
				script = "python ~/.dotfiles/config/home/desktop/scripts/notif";
			};
